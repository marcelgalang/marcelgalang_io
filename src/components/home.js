        ...
        <Page>
          <ScrollableAnchor id={'top'}>
            <Section styles='hero'>
              ...
              <a href='#hire-me' className='btn'>{connectText}</a>
            </Section>
          </ScrollableAnchor>
              ...
              <h3 className='title'>Projects</h3>
                <Section className=" photolinks clearfix">
                  <ul className="img-list-16-9" minWidth={480} >
                    <li>
                      <img alt="doctor_b_screen"s src={`${process.env.PUBLIC_URL}/img/drb-screenshot.png`}  />
                    ...
                    <li>
                      <img alt="guestlist_app_screen" src={`${process.env.PUBLIC_URL}/img/guestlist_screenshot.png`}  />
                      <span className="text-content-16-9">
                        <span>
            ...
            <Section styles='my-work'>
              ...
              <article className=" photolinks clearfix">
                <ul className="img-list">
                  <li>
                    <img alt="bond_st" rc={`${process.env.PUBLIC_URL}/img/bondst.jpg`} width="200px" height="200px"  />
                    <span className="text-content"><span>I am a New Yorker*.<br/>(*living in Philly)</span></span>

                  </li>
                  <li>
                    <img alt="cheesehead_hat" src={`${process.env.PUBLIC_URL}/img/cheesehead.jpg`} width="200px" height="200px" />
                    <span className="text-content"><span><a href="http://www.packers.com" target='_blank'>But I stay loyal to home.</a></span></span>
                  </li>
                  <li>
                    <img alt="winter"
                    src={`${process.env.PUBLIC_URL}/img/mplswinter.jpg`} width="200px" height="200px" />
                ...
                <ul className="img-list">
                  <li>
                    <img alt="Heavy Sleeper band" src={`${process.env.PUBLIC_URL}/img/HSUptownBar1.jpg`} width="200px" height="200px" />
                  ...
                  <li>
                    <img alt="fam" src={`${process.env.PUBLIC_URL}/img/xmas17.jpg`} width="200px" height="200px" />
                    <span className="text-content"><span>Nowadays, I am a father and husband. </span></span>
                  </li>
                  <li>
                    <img alt="power supply" src={`${process.env.PUBLIC_URL}/img/magps.jpg`} width="200px" height="200px" />
